...
import MerchantAnalytics from "../modules/merchantAnalytics/pages/merchantAnalytics";
...
import {
  processShopData,
  getRelevantEvent,
} from "../modules/dashboard/utils/dataProcessor";
      ...
      <main className="admin-main">
        <Routes>
          ...
          <Route
            path="/analytics"
            element={
              <Analytics data={rawData} updateMainFilter={updateMainFilter} />
            }
          />
